...
Growth Analyses:
4. Run models for mass gain and development time with diet and parasitization status as fixed effects, and ID within bin as random effects
...
ggsave("MsCcSurvMay19.png", width = 8, height = 5)
...
ggsave("MsCcSurvParaMay19.png", width = 8, height = 5)
